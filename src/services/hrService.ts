...
export const hrService = {
  ...
  getAttendanceCorrectionRequests: attendanceService.getAttendanceCorrectionRequests,
  submitAttendanceCorrection: attendanceService.submitAttendanceCorrection,
  reviewAttendanceCorrection: attendanceService.reviewAttendanceCorrection,
  getAttendancePayrollLock: attendanceService.getAttendancePayrollLock,
  getAttendancePayrollLockEvents: attendanceService.getAttendancePayrollLockEvents,
  advanceAttendancePayrollLock: attendanceService.advanceAttendancePayrollLock,
